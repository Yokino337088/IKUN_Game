...
namespace TJGenerators.UI
{
    ...
    public static class UIComponents
    {
        ...
        {
            GUILayout.BeginHorizontal();
            DrawSectionTitle("模型", uppercase: false);
            GUILayout.EndHorizontal();
        ...
        public static string DrawPromptInputBox(string value, string placeholder, string controlName = "prompt_input_box")
        {
            ...
            return DrawScrollablePromptText(innerRect, text, placeholder, controlName, contentHeight);
        }
            ...
            Action drawBeforeCount = null)
        {
            ...
            GUILayout.BeginHorizontal();
            DrawSectionTitle(title ?? "参考图片（可选）", uppercase: false);
            GUILayout.FlexibleSpace();
            ...
            bool isBusy = false)
        {
            ...
            string title = string.IsNullOrEmpty(text) ? "生成模型" : text;
            ...
            params GUILayoutOption[] options)
        {
            ...
            GUI.enabled = true;
            return DrawGenerateButtonWithCostAt(buttonRect, text, cost, enabled, isBusy);
        }
            ...
            string idleButtonLabel = null)
        {
            ...
            string idle = string.IsNullOrEmpty(idleButtonLabel) ? "生成" : idleButtonLabel;
            string buttonText = isGenerating ? "生成中..." : idle;
        ...
        public static void DrawHistoryEmptyState()
        {
            ...
            GUILayout.BeginHorizontal();
            GUILayout.FlexibleSpace();
            if (GUILayout.Button("第一次来？看看怎么用 →", SoftLinkStyle))
        ...
        public static bool DrawAdvancedSettingsFoldout(
            ...
            => AdvancedSettingsComponents.DrawAdvancedSettingsFoldout(expanded, provider, parameters, foldoutLabel);
