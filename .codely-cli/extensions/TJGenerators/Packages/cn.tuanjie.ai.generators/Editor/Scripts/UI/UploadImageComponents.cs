...
namespace TJGenerators.UI
{
    ...
    public static class UploadImageComponents
    {
        ...
        public static void DrawLargeImageUpload(
            ...
            string aiActionLabel = DefaultAiActionLabel,
            ...
            Action onAIGenClicked)
        {
            ...
            Rect aiActionHitRect = DrawLargeUploadEmptyState(frameRect, onAIGenClicked, DefaultAiActionLabel);
        ...
        private static void DrawLargeUploadTitleAndHint(Rect frameRect)
        {
            Rect titleRect = new Rect(
                ...
                frameRect.width,
                LargeTitleHeight);
            GUI.Label(titleRect, "点击上传图片", CommonStyles.UploadTitleStyle);
            ...
            GUI.Label(
                hintRect,
                "支持png/jpg/jpeg，文件大小最大不超过10M，分辨率最低要求128*128，最高限制4096*4096",
        ...
        private static Rect DrawLargeUploadAiActionRow(Rect frameRect, Action onAIGenClicked, string aiActionLabel)
        {
            ...
            string resolvedLabel = aiActionLabel ?? DefaultAiActionLabel;
            ...
            Action repaint)
        {
            ...
            {
                string path = EditorUtility.OpenFilePanel(PickImageDialogTitle, "", PickImageFileFilter);
        ...
        private static void DrawSingleUploadPlaceholder(Rect uploadAreaRect)
        {
            ...
            Rect hintRect = new Rect(
                ...
                SingleHintHeight);
            GUI.Label(hintRect, "点击上传图片（支持JPG、PNG格式）", CommonStyles.HintLabelStyle);
        }
            ...
            Action repaint)
        {
            ...
            Event.current.Use();
            string maxMsg = $"最多可选择 {maxReferenceImages} 张参考图片";
            EditorApplication.delayCall += () =>
